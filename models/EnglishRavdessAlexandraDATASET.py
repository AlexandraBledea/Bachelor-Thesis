...
class EnglishRavdessAlexandraDATASET(Strategy, ABC):
    ...
    def __init__(self):
        ...
        self.__path = "C:\\Users\\night\\Desktop\\Facultate An 3\\Thesis Experiments\\ALEXANDRA_DATASET\\SIMPLE FEATURE\\1\\"
    ...
    def execute(self, recording, actual_label):
        ...
        # self.__save_and_load_temporary_file(bytes(signal)
    ...
    def __get_features(self):
        ...
        result = FeaturesExtraction.extract_mel_spect_and_mfcc_features(signal, sample_rate)
