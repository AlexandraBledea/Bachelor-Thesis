...
class EnglishRavdessSpectralAxisModel(Strategy, ABC):

    def __init__(self):

        self.__path = "C:\\Users\\night\\Desktop\\Facultate An 3\\Thesis\\Github\\Bachelor-Thesis-Backend\\in-memory-models\\english-ravdess-spectral-axis\\"
