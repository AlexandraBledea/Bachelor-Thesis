...
class RomanianAlexandraSpectralAxisModel(Strategy, ABC):

    def __init__(self):

        self.__path = "C:\\Users\\night\\Desktop\\Facultate An 3\\Thesis\\Github\\Bachelor-Thesis-Backend\\in-memory-models\\romanian-alexandra-spectral-axis\\"
    ...
    def get_strategy_name(self):
        return "Alexandra Spectral Axis"
